...
public class TestAssignment1
{
    ...
    /**
     * Default constructor for test class TestAssignment1
     */
    public TestAssignment1()
    {
    }
    ...
    {
        final String EXPECTED = "Highest markup is 433.3333333333333%, for Surely You're Joking Mr. Feynman by Feynman"
            + NEWLINE + "";
